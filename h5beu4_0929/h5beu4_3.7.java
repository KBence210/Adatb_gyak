...
public class wh8l7e_3_7 implements Serializable {
	...
	public wh8l7e_3_7(String r, String t, int a) {
		this.rsz = r;
		this.tipus = t;
		this.ar = a;
	}
	...
	public static void hf4() {
		wh8l7e_3_7[] autoim = { new wh8l7e_3_7("R11", "Opel", 333), new wh8l7e_3_7("R12", "Fiat", 233),
				new wh8l7e_3_7("R14", "Skoda", 364) };
		try {
			ObjectOutputStream kifile = new ObjectOutputStream(new FileOutputStream("Autok.dat"));
			for (wh8l7e_3_7 auto : autoim) {
	...
	public static void hf5() {
		...
		try {
			...
			if (fn.exists()) {
				...
				try {
					while (true) {
						ma = (wh8l7e_3_7) kifile.readObject();
						if (ma.ar > 300) {
